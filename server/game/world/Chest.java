...
/**
 * This class represents a chest. A chest can be locked or unlocked. If it is
 * locked, a key is required to unlock it. Each chest contains at least one
 * loot.
 *
...
public class Chest extends Obstacle implements Container, Lockable {
	...
	/**
	 * The keyID specifies which key can open this chest. Only the key with the
