...
/**
 * PacketTypes contains inner classes that specifies which kind of packet are they going
 * to encode.
 * 
...
public class PacketTypes {
    ...
    public class MouseEvent extends Packet {
        ...
        public MouseEvent(int number, ClientInformation client1,
    ...
    public class KeyEvent extends Packet {
        ...
        // TODO: UPDATE PARAMETER BY PASSING THE VIEW/RENDERER TO UPDATE THE SCREEN OF
        // EACH PLAYER
