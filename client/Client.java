...
public class Client {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        /*
         * This is just for testing purposes. It reads the input from the console and
         * constructs a message or log in packet and broadcasts it to each client
         */
        ...
        consoleMessage = "Welcome to the SERVER!\n" + "IP address is : "
                + clientThread.getClientAddress() + " Port number is "
                + clientThread.getClientPort() + "\n";
