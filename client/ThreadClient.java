...
public class ThreadClient extends Thread {
    ...
    /**
     * Extracts the type of packet the client had received and calls the appropriate
    ...
    public void readMessage(DatagramPacket dPacket) {
        ...
        DataType type = Packet
                .getPacketType(new String(dPacket.getData()).trim().substring(0, 1));
    ...
    public void sendDataToServer(byte[] message) {
        DatagramPacket packet = new DatagramPacket(message, message.length, ipAddress,
                Server.PORTN_NUM);
        try {
